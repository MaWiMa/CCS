...
If you like to start translation to other languages, it would be great and you are welcome.

You want to help, but things like ruby, git and asciidoctor are aliens to you?
You only need an Editor (please do not use a word-proccessor).
...
http://www.methods.co.nz/asciidoc/[asciidoc] with http://asciidoctor.org/docs/[asciidoctor].
